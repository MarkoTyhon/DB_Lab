...
CREATE TABLE `order_items` (
  ...
  CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`component_id`) REFERENCES `components` (`component_id`)
...
INSERT INTO `order_items` VALUES (1,1,1,1),(2,1,4,2),(3,2,1,1),(4,2,2,1),(5,2,3,1),(6,2,5,1),(7,3,2,1),(8,3,5,2);
